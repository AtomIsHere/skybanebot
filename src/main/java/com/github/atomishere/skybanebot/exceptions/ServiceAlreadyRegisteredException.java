...
/**
 * Thrown when a service is registered that has the same name of another registered service
 */
public class ServiceAlreadyRegisteredException extends SkybaneBotException {
